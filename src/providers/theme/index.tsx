...
// Util Imports
import { rtlEmotionCacheOptions } from '@/core/theme/app/rtlCache'
...
const ThemeProvider = (props: Props) => {
  ...
  const theme = useMemo(() => {
    ...
    return extendTheme(
      deepmerge(coreTheme, {
        typography: {
          fontFamily: 'var(--font-vazirmatn), Inter, sans-serif'
        }
      })
    )
  ...
  const emotionCacheOptions = direction === 'rtl' ? rtlEmotionCacheOptions : { prepend: true }
